...
public class OnewayCommunicationPackage {
    ...
    private MessageHandler reply_msg;
     ...
     */
    public MessageHandler receiveFromOne() {
        ...
        this.tcp_worker = new TCP_Worker(this.clientSocket, this.received_Msg, CommType.receiveFromOne);
     ...
     */
    public boolean replyToOne(MessageHandler reply_msg) {
        boolean local_DEBUG = true;
        boolean DEBUG = global_DEBUG? local_DEBUG: global_DEBUG;
        ...
        this.tcp_worker.setCommType(CommType.replyToOne);
        this.jobType = this.tcp_worker.getCommType();
    ...
    public MessageHandler getReply_msg() {
        return reply_msg;
    }

    public void setReply_msg(MessageHandler reply_msg) {
